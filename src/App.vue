  ...
  <div class="layout">
    <el-container v-if="state.showMenu" class="container">
      <el-aside class="aside">
        ...
        >
          <el-menu-item-group>
            <el-menu-item index="/"><el-icon><Odometer /></el-icon>主页</el-menu-item>
          </el-menu-item-group>
          <el-sub-menu index="2">
            <template #title>
              <span>商品信息管理</span>
          ...
          <el-sub-menu index="3">
            ...
            <el-menu-item-group>
              <el-menu-item index="/order"><el-icon><List /></el-icon>订单信息管理</el-menu-item>
              <el-menu-item index="/comment"><el-icon><List /></el-icon>评论信息管理</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          <el-sub-menu index="4">
            <template #title>
            ...
            <el-menu-item-group>
              <el-menu-item index="/shops"><el-icon><User /></el-icon>店铺管理</el-menu-item>
              <el-menu-item index="/complaints"><el-icon><Menu /></el-icon>店铺投诉</el-menu-item>
            </el-menu-item-group>
          </el-sub-menu>
          <el-sub-menu index="5">
            <template #title>
            ...
            <el-menu-item-group>
              <el-menu-item index="/guest"><el-icon><User /></el-icon>用户管理</el-menu-item>
